...
backgroundGradient.addColorStop(0, '#9B7BC8')  // Adjusted color theme to pastel purple
backgroundGradient.addColorStop(1, '#CF9FFF') // This is your main theme color
...
function animate() {
    ...
    if(flag) creatMountainRange(1, canvas.height * 0.7, '#9B7BC8')
    if(flag) creatMountainRange(2, canvas.height * 0.6, '#9A79B7')
    if(flag) creatMountainRange(3, canvas.height * 0.4, '#CF9FFF') // Set mountain range to match theme

    c.fillStyle = '#6F4F8C'  // Color of ground layer to match theme
